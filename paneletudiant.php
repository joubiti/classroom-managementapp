                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Nombre d'étudiants: <div style="font-weight: bold; display: inline-block;"><?php echo $numberstudents ?></div>
                                </div>
                                <!-- /.panel-heading -->
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td <?php if ($name==$prenom): ?> style="font-weight: bold" <?php endif; ?>=><?php $name=$assoc['prenom'];
                                                    echo $name; ?></td>
